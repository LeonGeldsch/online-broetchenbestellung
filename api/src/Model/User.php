...
final class User extends AbstractModel {
    ...
    public function login( array &$errors, string &$token ) : bool {
        ...
        $username_exists = $this->usernameExists( $input_username );

        if ( $validate_username && $validate_password && $username_exists ) {
            ...
            if ( !$compare_passwords ) {
                ...
                $token = Authorize::createToken( $credentials );
            }
